...
valid_init,com,server_list_path,out,vortaro = use()

#If option not valid exits. Some of thoses checks could be deleted, because usage module performed it.
if not valid_init:
	sys.exit()
#It was removed, because new usage module performed this task.
#else:
