...
"""
	...
	except getopt.GetoptError, err: #Syntaxis does not work for Python 3.0 
	#except getopt.GetoptError as err: #For Python v3.0 
...
"""+sep+"\n\n"
	...
	"""
		...
		#except getopt.GetoptError as err: #Python v3
			print(str(err)) # It'll print something like "option -a not recognized"
			print(howto)
			sys.exit()
